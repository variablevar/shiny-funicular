...
class FreqaiDataKitchen:
    ...
    def find_features(self, dataframe: DataFrame) -> None:
        ...
        # Preserve existing training_features_list if already set (fixes prediction
        # mismatch where strategy adds columns not in trained model)
        if getattr(self, "training_features_list", None) and len(self.training_features_list) > 0:
            return
